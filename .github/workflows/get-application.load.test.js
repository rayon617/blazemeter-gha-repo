...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ get_application_load_test)
});
...
;// CONCATENATED MODULE: ./src/scenarios/application/get-application.load.test.ts
/**
 * Get Application Load Test with DP Token Authentication (BlazeMeter Compatible)
 * Tests application endpoint with funded state info under normal load
 *
 * Test type: Load
 * Purpose: Validate /application?includeFundedStateInfo=true endpoint performance with authentication
 *
...
/**
 * Main test function - tests /application endpoint with authentication
 * BlazeMeter Compatible: Uses per-VU token caching and user rotation
 */
/* harmony default export */ function get_application_load_test() {
    const user = getTestUserForVU();
    // Log test start on first iteration
    if (__ITER === 0) {
        console.log('='.repeat(60));
        console.log(`[VU ${__VU}] Starting Get Application Load Test`);
    ...
    // GET /application?includeFundedStateInfo=true
    const response = get('/application?includeFundedStateInfo=true', { headers });
    // Validate response
...
exports.default = get_application_load_test;

/******/ })()
;
//# sourceMappingURL=get-application.load.test.js.map