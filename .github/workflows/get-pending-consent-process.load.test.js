...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ get_pending_consent_process_load_test)
});
...
;// CONCATENATED MODULE: ./src/scenarios/application/get-pending-consent-process.load.test.ts
...
/* harmony default export */ function get_pending_consent_process_load_test() {
    const user = getTestUserForVU();
    if (__ITER === 0) {
        console.log(`[VU ${__VU}] Starting Get Pending Consent Process Load Test`);
    ...
    const response = get('/consent-process/pending/consent-process', { headers });
...
exports.default = get_pending_consent_process_load_test;

/******/ })()
;
//# sourceMappingURL=get-pending-consent-process.load.test.js.map