...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ get_favourites_load_test)
});
...
;// CONCATENATED MODULE: ./src/scenarios/application/get-favourites.load.test.ts
/**
 * Get Favourites Load Test with DP Token Authentication (BlazeMeter Compatible)
 * Tests property favourites endpoint under normal load
 *
 * Test type: Load
 * Purpose: Validate /property/favourites endpoint performance with authentication
 *
...
/**
 * Main test function - tests /property/favourites endpoint with authentication
 * BlazeMeter Compatible: Uses per-VU token caching and user rotation
 */
/* harmony default export */ function get_favourites_load_test() {
    const user = getTestUserForVU();
    // Log test start on first iteration
    if (__ITER === 0) {
        console.log('='.repeat(60));
        console.log(`[VU ${__VU}] Starting Get Favourites Load Test`);
    ...
    // GET /property/favourites
    const response = get('/property/favourites', { headers });
    // Validate response
...
exports.default = get_favourites_load_test;

/******/ })()
;
//# sourceMappingURL=get-favourites.load.test.js.map