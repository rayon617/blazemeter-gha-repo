...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ property_data_load_test)
});
...
;// CONCATENATED MODULE: ./src/scenarios/application/property-data.load.test.ts
/**
 * Property Data Load Test with DP Token Authentication (BlazeMeter Compatible)
 * Tests property data endpoint with images under normal load
 *
 * Test type: Load
 * Purpose: Validate /property/data endpoint performance with authentication
 *
...
/**
 * Main test function - tests /property/data endpoint with authentication
 * BlazeMeter Compatible: Uses per-VU token caching and user rotation
 */
/* harmony default export */ function property_data_load_test() {
    const user = getTestUserForVU();
    // Log test start on first iteration
    if (__ITER === 0) {
        console.log('='.repeat(60));
        console.log(`[VU ${__VU}] Starting Property Data Load Test`);
    ...
    // GET /property/data?gnafId=...&includeAllImages=true
    const response = get(`/property/data?gnafId=${user.gnafId}&includeAllImages=true`, { headers });
    // Validate response
...
exports.default = property_data_load_test;

/******/ })()
;
//# sourceMappingURL=property-data.load.test.js.map